...
const Login = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      // Simulating successful login without validating credentials
      const fakeUserData = {
        details: {
      ...
      dispatch({ type: "LOGIN_SUCCESS", payload: fakeUserData.details });
      localStorage.setItem("user", JSON.stringify(fakeUserData.details));
      notify();
                  ...
                  <div className="card-body p-4 p-lg-5 text-black">
                    <form>
                      <div className="d-flex align-items-center mb-3 pb-1">
                        <span className="h1 fw-bold mb-0">Book Your Stay</span>
                      </div>
